...
#define SIMD_ADD_ASM(dest, src1, src2)       \
    __asm__ __volatile__("vaddpd %1, %2, %0" \
                         : "=x"(dest)        \
                         : "x"(src1), "x"(src2));

#define SIMD_ADD_ASM_CHAINS()       \
    SIMD_ADD_ASM(_0x, _0x, _1x);    \
    SIMD_ADD_ASM(_2x, _2x, _3x);    \
    SIMD_ADD_ASM(_4x, _4x, _5x);    \
    SIMD_ADD_ASM(_6x, _6x, _7x);    \
    SIMD_ADD_ASM(_8x, _8x, _9x);    \
    SIMD_ADD_ASM(_10x, _10x, _11x); \
    SIMD_ADD_ASM(_12x, _12x, _13x); \
    SIMD_ADD_ASM(_14x, _14x, _15x); \
    SIMD_ADD_ASM(_16x, _16x, _17x); \
    SIMD_ADD_ASM(_18x, _18x, _19x); \
    SIMD_ADD_ASM(_20x,_20x,_21x);\
	SIMD_ADD_ASM(_22x,_22x,_23x);\
	SIMD_ADD_ASM(_24x,_24x,_25x);\
	SIMD_ADD_ASM(_26x,_26x,_27x);\
	SIMD_ADD_ASM(_28x,_28x,_29x);\
	// SIMD_ADD_ASM(_30x,_30x,_31x);\
	// SIMD_ADD_ASM(_32x,_32x,_33x);

#define SIMD_ADD_ASM_CHAINS_10() \
    SIMD_ADD_ASM_CHAINS();       \
    SIMD_ADD_ASM_CHAINS();       \
    SIMD_ADD_ASM_CHAINS();       \
    SIMD_ADD_ASM_CHAINS();       \
...
#define SIMD_ADD_ASM_CHAINS_100() \
    SIMD_ADD_ASM_CHAINS_10();     \
    SIMD_ADD_ASM_CHAINS_10();     \
    SIMD_ADD_ASM_CHAINS_10();     \
    SIMD_ADD_ASM_CHAINS_10();     \
    SIMD_ADD_ASM_CHAINS_10();     \
...
#define SIMD_ADD_ASM_CHAINS_1000() \
    SIMD_ADD_ASM_CHAINS_100();     \
    SIMD_ADD_ASM_CHAINS_100();     \
    SIMD_ADD_ASM_CHAINS_100();     \
    SIMD_ADD_ASM_CHAINS_100();     \
    SIMD_ADD_ASM_CHAINS_100();     \
